...
const CartProvider = ({ children })=>{
    ...
    const applyCoupon = async (couponCode)=>{
        try {
            ...
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const res = await fetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApiUrl"])('/api/coupons/validate'), {
                method: 'POST',
...
"[project]/components/GoToCartBar.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const GoToCartBar = ()=>{
    const { items } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CartContext$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    const [showBar, setShowBar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13df901e._.js.map