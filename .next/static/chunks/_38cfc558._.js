...
const CartProvider = (param)=>{
    ...
    const addToCart = function(product, selectedSize) {
        ...
        var _product_sizes_find;
        const price = ((_product_sizes_find = product.sizes.find((size)=>size.size === selectedSize)) === null || _product_sizes_find === void 0 ? void 0 : _product_sizes_find.price) || 0;
        dispatch({
            type: 'ADD_ITEM',
            payload: {
                id: product.id,
...
//# sourceMappingURL=_38cfc558._.js.map