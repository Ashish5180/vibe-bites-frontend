...
const AdminPage = () => {
  ...
  useEffect(() => {
    ...
    const checkAuth = async () => {
      try {
        ...
        const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/auth/me`, {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
          }
  ...
  const loadDashboardStats = useCallback(async () => {
    try {
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/dashboard`, {
  ...
  const loadUsers = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/users?${params}`, {
        headers: getAuthHeaders()
      })
  ...
  const loadProducts = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/products?${params}`, {
        headers: getAuthHeaders()
      })
  ...
  const loadOrders = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/orders?${params}`, {
        headers: getAuthHeaders()
      })
  ...
  const loadCoupons = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/coupons?${params}`, {
        headers: getAuthHeaders()
      })
  ...
  const loadReviews = useCallback(async () => {
    try {
      ...
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/reviews/admin?${params}`, {
        headers: getAuthHeaders()
      })
  ...
  const handleUserStatusToggle = async (userId, currentStatus) => {
    try {
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/users/${userId}/status`, {
        method: 'PUT',
        headers: getAuthHeaders(),
  ...
  const handleOrderStatusUpdate = async (orderId, newStatus) => {
    try {
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/orders/${orderId}/status`, {
        method: 'PUT',
        headers: getAuthHeaders(),
  ...
  const handleReviewStatusToggle = async (reviewId, isActive) => {
    try {
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/reviews/admin/${reviewId}/status`, {
        method: 'PUT',
        headers: getAuthHeaders(),
...
Verified: ${review.verified ? 'Yes' : 'No'}
  ...
  const handleDelete = async (type, id) => {
    ...
    try {
      const response = await fetch(`${'https://vibebitstest-env.eba-ubvupniq.ap-south-1.elasticbeanstalk.com/api'}/admin/${type}/${id}`, {
        method: 'DELETE',
        headers: getAuthHeaders()
      })
